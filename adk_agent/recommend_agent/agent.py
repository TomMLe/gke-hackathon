...
root_agent = Agent(
    ...
    instruction="You are a product recommendation agent for fashion items. Given details of an abandoned cart, use the recommend_items tool to suggest similar fashion products.",
